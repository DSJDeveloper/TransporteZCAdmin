      ...
      <table style="width:100%;border-collapse:collapse;font-size:10pt;">
        <thead>
          <tr style="background:#f2f2f2;">
            ...
            <th style="padding:8px 12px;border:1px solid #ddd;font-weight:700;text-align:left;color:#1e293b;">HORARIO</th>
          </tr>
        </thead>
        <tbody>
          ${rows.map((r, i) => `
            <tr style="background:${i % 2 === 0 ? '#fff' : '#f9f9f9'};">
              ...
              <td style="padding:6px 12px;border:1px solid #ddd;color:#334155;">${r.route ?? ''}</td>
              <td style="padding:6px 12px;border:1px solid #ddd;color:#334155;">${r.shedule}</td>
            </tr>
          `).join('')}
        </tbody>
      </table>
