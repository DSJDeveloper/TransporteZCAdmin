...
CREATE TABLE IF NOT EXISTS public.clients (id bigint, name character varying(255), phone character varying(255), documentID character varying(255), email character varying(255), creditLimit character varying(255), status character varying(255), createAt timestamp without time zone, createBy character varying(255), carrer character varying(255), balance numeric, uid character varying(1000));

CREATE TABLE IF NOT EXISTS public.units (id bigint, name character varying(255), number character varying(255), plate character varying(255), status integer, driver character varying(255));
...
CREATE TABLE IF NOT EXISTS public.transactions (id integer, uid character varying(255), idclient integer, createBy integer, amount numeric, status integer, created_at timestamp without time zone, idunit integer, shedule character varying(255), newBalanceClient numeric);

CREATE TABLE IF NOT EXISTS public.horario (id bigint, code character varying(10), shudle character varying(20), status integer);

CREATE TABLE IF NOT EXISTS public.solicitude (id integer, date character varying(11), idclient integer, shedule character varying(255), route character varying(255), status smallint);
