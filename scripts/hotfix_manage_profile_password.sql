-- ============================================================
-- HOTFIX: manage_profile no actualizaba encrypted_password
-- en auth.users al hacer UPDATE, causando "Invalid login credentials"
-- ============================================================

BEGIN;

-- Eliminar overloads previas para poder recrear sin ambigüedad
...
BEGIN
    ...
    ELSIF LOWER(p_action) = 'update' THEN
        ...
        -- Sync name & email to clients (uid es varchar, castear p_user_id a text)
