...
REMOTE_PATH="/var/www/betatransportezcadmin"
LOCAL_DIST="dist"
NGINX_SITES="/etc/nginx/sites-available"
NGINX_ENABLED="/etc/nginx/sites-enabled"
CONF_NAME="betatransportransportezcadmintezc"
...
#VITE_BUILD_HASH="$BUILD_HASH" npm run build -- --mode=beta
VITE_BUILD_HASH="$BUILD_HASH" npx run-p type-check "build-only --mode=beta"
